...
const projects = [
  {
    ...
    description: [
      ...
      'I designed the website to be visually appealing, user-friendly, and informative and focused on highlighting the benefits of membership in the cooperative. The website also included an online application form, making it easy for new members to apply and join the cooperative.',
  ...
  },
  {
    ...
    description: [
      ...
      'The primary goal of Velmar is to provide comic fans with a platform to share their love for comics. The platform allows users to create and read comics and participate in discussions with other fans. It also offers a range of features like event scheduling, location-based recommendations, and social media integration, making it a comprehensive platform for comic enthusiasts.',
